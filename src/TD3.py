...
# Reddit
reddit = praw.Reddit(client_id='J84kxymaZdKMDdplOHKoEQ',client_secret='TcR1l8FaeqUgEcWYmqu30pXYP8MRog',user_agent='redit_scrapping')
...
with open("corpus/out.pkl", "wb") as f:
    pickle.dump(corpus_plus100, f)
    
with open("corpus/out.pkl", "rb") as f:
